...
<style scoped>
.folder-picker small{display:block;color:#6f869c;font-size:11px;margin-top:7px}.folder-current{width:100%;display:flex;align-items:center;gap:8px;border:1px solid #294963;background:#081725;color:#cfe0ee;border-radius:10px;padding:11px 12px;cursor:pointer;text-align:left}.folder-current:hover{border-color:#49b6ff;background:#0b2135}.folder-current span{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.folder-current svg:first-child{color:#5ebcff;flex:none}.folder-current svg:last-child{color:#6c8aa2;flex:none}.folder-overlay{position:fixed;inset:0;z-index:20;display:grid;place-items:center;padding:20px;background:#020813b8;backdrop-filter:blur(8px);animation:folderFade .2s ease}.folder-dialog{width:min(620px,100%);max-height:min(720px,90vh);display:flex;flex-direction:column;background:#0b1a2a;border:1px solid #2b526f;border-radius:18px;box-shadow:0 24px 80px #0009;overflow:hidden;animation:folderPop .25s ease}.folder-dialog-header{display:flex;justify-content:space-between;align-items:start;padding:22px 24px 15px}.folder-dialog-header h3{font:600 19px 'Space Grotesk';color:#f0f6fc;margin:6px 0 0}.icon-button{display:grid;place-items:center;border:0;background:#132d43;color:#92adc2;width:32px;height:32px;border-radius:9px;cursor:pointer}.icon-button:hover{color:#fff;background:#20425e}.folder-path{margin:0 24px 12px;padding:10px 12px;border-radius:8px;background:#071523;border:1px solid #1d3a51;color:#85afca;font:11px monospace;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.folder-list{min-height:190px;overflow:auto;padding:0 12px 12px}.folder-entry{width:100%;display:flex;align-items:center;gap:10px;border:0;border-bottom:1px solid #193149;background:transparent;color:#c9d9e7;padding:12px;border-radius:7px;cursor:pointer;text-align:left}.folder-entry:hover{background:#12334d;color:#fff}.folder-entry span{flex:1;font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.folder-entry svg:first-child{color:#62bfff;flex:none}.folder-entry svg:last-child{color:#61839c;flex:none}.root-entry{background:#0f263a;margin-bottom:5px}.parent-entry{color:#8bb5cd}.folder-loading,.folder-empty{text-align:center;padding:42px 10px;color:#7894aa;font-size:12px}.folder-loading svg{display:inline-block;vertical-align:middle;color:#5ebcff;animation:folderSpin 1.2s linear infinite}.folder-error{margin:0 24px 12px;padding:9px 11px;border-radius:8px;background:#48252c;border:1px solid #8c4550;color:#ffb0b0;font-size:11px}.folder-dialog-footer{display:flex;justify-content:flex-end;gap:9px;padding:15px 24px;border-top:1px solid #1b344b;background:#091725}.secondary-button{border:1px solid #294963;border-radius:9px;background:transparent;color:#a4bacb;padding:10px 14px;font:500 12px 'DM Sans';cursor:pointer}.secondary-button:hover{background:#142d43;color:#fff}.compact-button{height:auto;padding:10px 14px}@keyframes folderFade{from{opacity:0}to{opacity:1}}@keyframes folderPop{from{opacity:0;transform:scale(.97) translateY(8px)}to{opacity:1;transform:scale(1) translateY(0)}}@keyframes folderSpin{to{transform:rotate(360deg)}}
</style>
